...
#define ANSI_COLOR_MAGENTA "\033[38;2;245;169;184m"
#define ANSI_COLOR_CYAN    "\033[38;2;91;206;250m"
#define ANSI_COLOR_WHITE   "\033[38;2;255;255;255m"
...
void color_by_line(char* fname, char* cscheme){
    ...
    {
        /* code */
        int* colors = scheme.colors[(i % scheme.color_count)];
        printf("\033[38;2;%d;%d;%dm %s",colors[0],colors[1],colors[2],output);
        i++;
    }
    fclose(fd);
    free_scheme(scheme);
